...
namespace VitaWriting.Configuration
{
    public class YamlConfiguration : IConfiguration
    {
        ...
        public YamlConfiguration(string name, string currentPath)
        {
            _name = name;
        ...
        {
            return Get(path) as List<string>;
        }

        public List<int> GetIntegerList(string path)
        {
            return Get(path) as List<int>;
        }

        public List<bool> GetBooleanList(string path)
        {
            return Get(path) as List<bool>;
        }

        public List<double> GetDoubleList(string path)
        {
            return Get(path) as List<double>;
        }

        public List<float> GetFloatList(string path)
        {
            return Get(path) as List<float>;
        }

        public List<long> GetLongList(string path)
        {
            return Get(path) as List<long>;
        }

        public List<byte> GetByteList(string path)
        {
            return Get(path) as List<byte>;
        }

        public List<char> GetCharacterList(string path)
        {
            return Get(path) as List<char>;
        }

        public List<short> GetShortList(string path)
        {
            return Get(path) as List<short>;
        }

        public List<Dictionary<string, object>> GetMapList(string path)
        {
            return Get(path) as List<Dictionary<string, object>>;
        }
        ...
        public void SaveToFile(FileInfo file)
        {
            ...
            var yamlContent = serializer.Serialize(_values);
